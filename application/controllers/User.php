...
class User extends CI_Controller
{
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            // cek kalu ada gambar untuk di update
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Profile sudah di ganti !!</div>');
            redirect('user');
        }
    }
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('new_password2', 'Ulang Password Baru', 'required|trim|min_length[4]|matches[new_password1]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                if ($current_password == $new_password) {
                    ...
                    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Password sudah ok !!</div>');
                    redirect('user/changepassword');
                }
            }
        }
